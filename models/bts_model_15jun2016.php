...
$this->db->query($sql);
$sql="update reasonentry a, btsdata b set a.ssa=b.ssa, a.btsname=b.btsname where a.xtraid = b.xtraid";
$this->db->query($sql);
...
$sql="insert into reasontable (btsfail_id, details)(select id, details from reasonentry)";
$this->db->query($sql);
